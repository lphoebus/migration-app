import{ba as w,aw as l}from"./index-ChIkxCSH.js";import{a as c}from"./BindType-BBwFZqyN.js";const b=()=>w.getLogger("esri.views.3d.webgl-engine.core.shaderModules.shaderBuilder");class S{constructor(){this._includedModules=new Map}include(e,n){this._includedModules.has(e)?this._includedModules.get(e):(this._includedModules.set(e,n),e(this.builder,n))}}class k extends S{constructor(){super(...arguments),this.vertex=new f,this.fragment=new f,this.attributes=new E,this.varyings=new F,this.extensions=new p,this.outputs=new g}get fragmentUniforms(){return this.fragment.uniforms.entries}get builder(){return this}generate(e,n=!1){const t=this.extensions.generateSource(e),r=this.attributes.generateSource(e),a=this.varyings.generateSource(e),i=e==="vertex"?this.vertex:this.fragment,u=i.uniforms.generateSource(),d=i.code.generateSource(),$=i.main.generateSource(n),_=e==="vertex"?D:x,T=i.constants.generateSource(),v=this.outputs.generateSource(e);return`#version 300 es
${t.join(`
`)}
${_}
${T.join(`
