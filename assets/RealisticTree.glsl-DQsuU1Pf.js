import{kw as Q,aJ as ta,kv as $e,j1 as Ee,kB as oa,iF as Pa,eD as U,aU as $,n7 as Ra,ak as me,hp as ra,lb as ne,a$ as s,b0 as be,b1 as Fa,cM as oe,gk as Da,go as je,gr as ja,gp as Va,ei as Ba,i5 as Ha,kg as Wa,ku as Ua,ct as qa,bk as E,d2 as Ya,m2 as ka,qv as Za,lX as Ve,kG as Be,bA as Xa,aW as Ja,bq as Ka,e3 as Te,ez as Qa,eB as He,bm as et,iD as at}from"./index-Byn_dG8u.js";import{H as tt}from"./InterleavedLayout-Rv2TeVbD.js";import{n as g,u as ee,t as We,o as we,r as ot}from"./ShaderOutput-DnYY5J1_.js";import{n as _,a as T,t as he}from"./NormalAttribute.glsl-Yl2Roi3d.js";import{aO as ze,aZ as h,z as ia,a_ as rt,a$ as it,b0 as G,b1 as nt,b2 as st,b3 as lt,D as se,p as ct,K as dt,q as ut,h as I,an as R,c as j,a2 as V,b4 as B,a4 as K,G as N,a6 as H,au as mt,a5 as ht,b5 as ft,ak as F,b6 as pt,J as na,as as sa,F as la,aX as ca,S as vt,P as _e,Q as fe,I as da,b7 as gt,i as le,aP as xt,T as bt,U as Me,R as re,m as ua,o as O,B as Oe,C as ce,l as Tt,b8 as wt,b9 as Mt,L as St,aa as yt,ba as ma,bb as ha,g as de,bc as fa,a3 as pa,a9 as va,a8 as ga,a7 as xa,H as ue,bd as ba,W as Ct,V as Ue,af as Nt,ag as Ot,ah as $t,ai as Et,ab as zt,ac as _t,ad as At,ae as It,aj as Gt,al as P,$ as d,v as Lt,A as Se,am as Pt,az as Rt,x as Ft,d as Dt,ao as jt,y as Vt,aJ as Bt}from"./VerticalOffset.glsl-Bfn_Gmjz.js";import{i as A,a as qe,e as ae,n as pe}from"./basicInterfaces-CZwQPxTp.js";import{e as b}from"./VertexAttribute-Cq4MnHjR.js";import{B as Ae,g as Ie,f as Ht}from"./renderState-DxryJrEn.js";import{n as r,t as v}from"./glsl-BH37Aalp.js";import{a as Ge}from"./BindType-BBwFZqyN.js";import{i as ve}from"./ShaderBuilder-DF4nfqSJ.js";import{e as Le,o as q}from"./mat3f64-q3fE-ZOt.js";import{o as Ye}from"./mat4f64-Dk4dwAN8.js";import"./boundedPlane-njfr4EWw.js";import"./sphere-Cr73JZjN.js";import{o as Wt,r as Ut}from"./doublePrecisionUtils-B0owpBza.js";function qt(a){a.vertex.code.add(r`
...
}`)}function Pe(a,e){const t=a.fragment.code;a.include(ze),e.pbrMode!==h.Normal&&e.pbrMode!==h.Schematic&&e.pbrMode!==h.Simplified&&e.pbrMode!==h.TerrainWithWater||(t.add(r`float normalDistribution(float NdotH, float roughness)
{
...
return outColor;
}`))}function tr(a,e){const t=a.fragment.code;a.include(ze),t.add(r`
...
}`)):o===1?(t.uniforms.add(new O("lightingAmbientSH_R",({lighting:i})=>E(z,i.sh.r[0],i.sh.r[1],i.sh.r[2],i.sh.r[3])),new O("lightingAmbientSH_G",({lighting:i})=>E(z,i.sh.g[0],i.sh.g[1],i.sh.g[2],i.sh.g[3])),new O("lightingAmbientSH_B",({lighting:i})=>E(z,i.sh.b[0],i.sh.b[1],i.sh.b[2],i.sh.b[3]))),t.code.add(r`vec3 calculateAmbientIrradiance(vec3 normal, float ambientOcclusion) {
vec4 sh0 = vec4(
0.282095,
0.488603 * normal.x,
0.488603 * normal.z,
...
return ambientLight * (1.0 - ambientOcclusion);
}`)):o===2&&(t.uniforms.add(new se("lightingAmbientSH0",({lighting:i})=>U(ea,i.sh.r[0],i.sh.g[0],i.sh.b[0])),new O("lightingAmbientSH_R1",({lighting:i})=>E(z,i.sh.r[1],i.sh.r[2],i.sh.r[3],i.sh.r[4])),new O("lightingAmbientSH_G1",({lighting:i})=>E(z,i.sh.g[1],i.sh.g[2],i.sh.g[3],i.sh.g[4])),new O("lightingAmbientSH_B1",({lighting:i})=>E(z,i.sh.b[1],i.sh.b[2],i.sh.b[3],i.sh.b[4])),new O("lightingAmbientSH_R2",({lighting:i})=>E(z,i.sh.r[5],i.sh.r[6],i.sh.r[7],i.sh.r[8])),new O("lightingAmbientSH_G2",({lighting:i})=>E(z,i.sh.g[5],i.sh.g[6],i.sh.g[7],i.sh.g[8])),new O("lightingAmbientSH_B2",({lighting:i})=>E(z,i.sh.b[5],i.sh.b[6],i.sh.b[7],i.sh.b[8]))),t.code.add(r`vec3 calculateAmbientIrradiance(vec3 normal, float ambientOcclusion) {
vec3 ambientLight = 0.282095 * lightingAmbientSH0;
vec4 sh1 = vec4(
0.488603 * normal.x,
0.488603 * normal.z,
...
}`))}const ea=$(),z=oa();function Fe(a){a.constants.add("ambientBoostFactor","float",Mt)}function De(a){a.uniforms.add(new le("lightingGlobalFactor",e=>e.lighting.globalFactor))}function $a(a,e){const t=a.fragment;switch(a.include(Re,e),e.pbrMode!==h.Disabled&&a.include(Pe,e),a.include(mo,e),a.include(ze),t.code.add(r`
