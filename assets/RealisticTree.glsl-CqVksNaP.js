import{iP as ta,kJ as Q,bj as ra,kI as ze,kO as ia,iu as Ga,gb as Y,bB as z,n5 as Da,al as he,hH as na,kq as se,bg as c,bh as Me,bi as ja,d6 as ie,ee as Fa,ei as Re,ek as Va,ej as Ra,aV as Ba,il as Ha,k7 as Wa,kl as Ua,fW as Ya,bV as I,fv as qa,pL as Ja,xE as k,kX as Za,kw as Be,kT as He,ca as ka,bD as Xa,c0 as Ka,fS as Te,g7 as Qa,fV as We,bY as eo,ix as ao}from"./index-Ua1bMCr9.js";import{O as oo}from"./InterleavedLayout-DWhvgnWm.js";import{n as w,u as ee,r as Ue,o as Se,t as to,C as ro}from"./ShaderOutput-Bdd80V3g.js";import{n as A,a as M,t as ve}from"./NormalAttribute.glsl-nBs5_jgz.js";import{aY as io,aZ as no,a_ as j,a$ as so,b0 as lo,b1 as co,a8 as le,b2 as uo,b3 as mo,a1 as ho,ad as vo,b4 as po,g as D,k as ae,_ as R,aq as B,b5 as H,b as K,h as $,as as W,r as fo,e as go,b6 as xo,A as V,b7 as bo,ag as sa,d as la,aa as ca,aW as da,ae as wo,v as _e,x as pe,ac as ua,b8 as Mo,q as ce,aL as To,ah as So,ai as Ye,a5 as ye,l as yo,o as E,b9 as v,aK as Ie,a6 as Ee,a7 as de,a2 as Co,ba as No,bb as $o,i as Le,bc as Oo,c as Eo,bd as ma,$ as ue,be as ha,ar as va,f as pa,a as fa,at as ga,ab as me,bf as xa,K as zo,au as _o,ay as Io,F as Lo,az as Ao,aA as Po,aB as Go,av as Do,aw as jo,ax as Fo,z as Vo,B as G,C as m,D as Ro,E as Ce,aC as Bo,N as Ho,ap as Wo,aU as Uo,aD as Yo,O as qo,W as Jo}from"./OutputColorHighlightOID.glsl-CLPsAqWS.js";import{i as N,a as qe,e as oe,n as te}from"./basicInterfaces-CZwQPxTp.js";import{e as x}from"./VertexAttribute-BfkzOMLV.js";import{B as Ae,g as Pe,f as Zo}from"./renderState-DYJbPDjL.js";import{n as i,t as p}from"./glsl-Cj7KC756.js";import{a as fe}from"./BindType-BBwFZqyN.js";import{i as ge}from"./ShaderBuilder-Czou906U.js";import{e as Ge,r as q}from"./mat3f64-B5o_lm6j.js";import{r as Je}from"./mat4f64-q_b6UJoq.js";import"./boundedPlane-sA7TS8Sk.js";import"./sphere-CFE5bvGp.js";function ko(e){e.vertex.code.add(i`
...
gl_FragDepth = fragDepth;
  ...
  `)}function Sa(e,a){const{vertex:t,fragment:r,varyings:o}=e,{hasColorTexture:s,alphaDiscardMode:n}=a,l=s&&n!==N.Opaque,{output:d,normalType:h,hasColorTextureTransform:f}=a;switch(d){case w.Depth:R(t,a),e.include(B,a),r.include(W,a),e.include(H,a),l&&r.uniforms.add(new $("tex",g=>g.texture)),t.main.add(i`vpos = getVertexInLocalOriginSpace();
...
forwardTextureCoordinates();`),e.include(U,a),r.main.add(i`
        ...
        ${p(l,i`vec4 texColor = texture(tex, ${f?"colorUV":"vuv0"});
                discardOrAdjustAlpha(texColor);`)}`);break;case w.Shadow:case w.ShadowHighlight:case w.ShadowExcludeHighlight:case w.ViewshedShadow:case w.ObjectAndLayerIdColor:R(t,a),e.include(B,a),e.include(H,a),e.include(K,a),e.include(at,a),r.include(W,a),e.include(go,a),xo(e),o.add("depth","float",{invariant:!0}),l&&r.uniforms.add(new $("tex",g=>g.texture)),t.main.add(i`vpos = getVertexInLocalOriginSpace();
vpos = subtractOrigin(vpos);
vpos = addVerticalOffset(vpos, localOrigin);
...
forwardObjectAndLayerIdColor();`),e.include(U,a),r.main.add(i`
        ...
        ${d===w.ObjectAndLayerIdColor?i`outputObjectAndLayerIdColor();`:i`outputDepth(depth);`}`);break;case w.Normal:{R(t,a),e.include(B,a),e.include(ve,a),e.include(ba,a),e.include(H,a),e.include(K,a),l&&r.uniforms.add(new $("tex",y=>y.texture)),h===M.ScreenDerivative&&o.add("vPositionView","vec3",{invariant:!0});const g=h===M.Attribute||h===M.Compressed;t.main.add(i`
        ...
        fragColor = vec4(0.5 + 0.5 * normal, 1.0);`);break}case w.Highlight:R(t,a),e.include(B,a),e.include(H,a),e.include(K,a),l&&r.uniforms.add(new $("tex",g=>g.texture)),t.main.add(i`vpos = getVertexInLocalOriginSpace();
vpos = subtractOrigin(vpos);
vpos = addVerticalOffset(vpos, localOrigin);
gl_Position = transformPosition(proj, view, vpos);
...
}`),s&&n!==V.None&&(e.include(bo,a),t.uniforms.add(l===fe.Pass?new $("normalTexture",h=>h.textureNormal):new sa("normalTexture",h=>h.textureNormal)),d&&(t.uniforms.add(new la("scale",h=>h.scale??Da)),t.uniforms.add(new j("normalTextureTransformMatrix",h=>h.normalTextureTransformMatrix??q))),t.code.add(i`vec3 computeTextureNormal(mat3 tangentSpace, vec2 uv) {
...
}`))}const aa=z(),L=ia();function vt(e){e.code.add(i`vec3 evaluateDiffuseIlluminationHemisphere(vec3 ambientGround, vec3 ambientSky, float NdotNG) {
...
return outColor;
}`);default:case v.COUNT:}}let gt=class extends Le{constructor(a,t,r){super(a,"mat4",fe.Draw,(o,s,n,l)=>o.setUniformMatrix4fv(a,t(s,n,l)),r)}},xt=class extends Le{constructor(a,t,r){super(a,"mat4",fe.Pass,(o,s,n)=>o.setUniformMatrix4fv(a,t(s,n)),r)}};function bt(e){e.fragment.uniforms.add(new xt("shadowMapMatrix",(a,t)=>t.shadowMap.getShadowMapMatrices(a.origin),4)),$a(e)}function wt(e){e.fragment.uniforms.add(new gt("shadowMapMatrix",(a,t)=>t.shadowMap.getShadowMapMatrices(a.origin),4)),$a(e)}function $a(e){const{fragment:a}=e;a.uniforms.add(new E("cascadeDistances",t=>t.shadowMap.cascadeDistances),new Oo("numCascades",t=>t.shadowMap.numCascades)),a.code.add(i`const vec3 invalidShadowmapUVZ = vec3(0.0, 0.0, -1.0);
...
}`)):e.vertex.code.add(i`void forwardColorUV(){}`)}function yt(e,a){a.hasNormalTextureTransform&&a.textureCoordinateType!==V.None?(e.varyings.add("normalUV","vec2"),e.vertex.uniforms.add(new j("normalTextureTransformMatrix",t=>t.normalTextureTransformMatrix??q)).code.add(i`void forwardNormalUV(){
normalUV = (normalTextureTransformMatrix * vec3(vuv0, 1.0)).xy;
}`)):e.vertex.code.add(i`void forwardNormalUV(){}`)}function Ct(e,a){a.hasEmissionTextureTransform&&a.textureCoordinateType!==V.None?(e.varyings.add("emissiveUV","vec2"),e.vertex.uniforms.add(new j("emissiveTextureTransformMatrix",t=>t.emissiveTextureTransformMatrix??q)).code.add(i`void forwardEmissiveUV(){
emissiveUV = (emissiveTextureTransformMatrix * vec3(vuv0, 1.0)).xy;
}`)):e.vertex.code.add(i`void forwardEmissiveUV(){}`)}function Nt(e,a){a.hasOcclusionTextureTransform&&a.textureCoordinateType!==V.None?(e.varyings.add("occlusionUV","vec2"),e.vertex.uniforms.add(new j("occlusionTextureTransformMatrix",t=>t.occlusionTextureTransformMatrix??q)).code.add(i`void forwardOcclusionUV(){
occlusionUV = (occlusionTextureTransformMatrix * vec3(vuv0, 1.0)).xy;
}`)):e.vertex.code.add(i`void forwardOcclusionUV(){}`)}function $t(e,a){a.hasMetallicRoughnessTextureTransform&&a.textureCoordinateType!==V.None?(e.varyings.add("metallicRoughnessUV","vec2"),e.vertex.uniforms.add(new j("metallicRoughnessTextureTransformMatrix",t=>t.metallicRoughnessTextureTransformMatrix??q)).code.add(i`void forwardMetallicRoughnessUV(){
